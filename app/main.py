...
APP_VERSION = "1.7.0"
VERSION_CHANGES = [
    "全新拼豆工作台：奶油白、莓果粉与鼠尾草绿，搭配原创豆粒小花",
    "重新设计上传区、四种板子卡片与本地 / Image2 双生成入口",
    "统一图纸预览、像素编辑器、豆粒材料清单与 API 设置样式",
    "优化手机和平板布局、键盘焦点提示，增加可展开的版本更新记录",
    "修复 API 设置异步请求后按钮不恢复及切换图纸后编辑面板残留的问题",
]
